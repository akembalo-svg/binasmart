...
For the purpose of this Directive, unless the context requires otherwise:
  2.1. “A person residing in Ethiopia” refers to an Ethiopian National Residing in
  ...
  2.2. “Acquiring bank/acquirer” means a bank or a member bank of
 ...
 2.3. “Agriculture machines/inputs importers” means importers engaged in
...
2.5.    “All-in-cost” means rate of interest, other fees and expenses in foreign
        currency excluding commitment fee and pre-payment fee;
2.6.    "Authorized Bank" means any bank established in accordance with the law
        and authorized by the National Bank of Ethiopia to undertake banking
        business and foreign exchange transactions;
2.7.    “Authorized foreign exchange dealers” means a business entity in whatever
        legal form authorized to engage in selected segments of the foreign exchange
        market with NBE permission;
2.8.    “Bank” means a company licensed by the National Bank to undertake
        banking business, or a bank owned by the Government;
2.9.    “Bank Identifier Code (BIC)” means a unique address which, in a
...
2.81. “Start-Up Companies” means those companies whose specific
...
3.1.   This Directive shall apply to all transactions related to foreign exchange and
          covers:
...
5.1. Banks and authorized foreign exchange dealers are allowed to buy and sell
   ...
   5.4. The Indicative Daily Exchange Rate shall serve as a reference price, but not
        ...
        dealers in their foreign exchange transactions at the start of the following
        business day.
...
1.   Conditions for issuance of license
...
11.1   Eligibility to Provide International Remittance Services

11.1.1 Banks and other Authorized Remittance Service Representatives
...
a.   Install card personalization machine or terminal, or produce
                    valid outsourcing contractual agreement for card
                    personalization;
...
1. Authorized banks have the responsibility to expedite
            ...
            2. Authorized banks shall notify to the travelers the fees and
               service    payment      required   for    one-time     card
...
system shall facilitate immediate receipt of funds through their
     ...
     12.6.4 Upon receipt of payment for services delivered using vouchers or
            ...
            equivalent amount in Birr at the prevailing exchange r
