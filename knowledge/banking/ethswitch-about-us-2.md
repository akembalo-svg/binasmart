...
To be best in the class payment network in Africa by 2035
...
We will always act ethically and honestly in all our dealings with customers, employees, and partners .

### Security

We will ensure that our systems are secure and protect customer data from unauthorized access or misuse.

### Innovative

We will strive to stay ahead of the curve by continuously developing new products and services that meet customer needs
today and tomorrow.

### Customer_focused

Our business is entirely to serve its customers through cooperative, innovative, and scalable shared platforms.

### Enabler

An enabler for financial service providers, is a technology that streamlines the process of conducting financial transactions digitally through the company’s platforms.

### Employee-Focused

We strive to create a positive and inclusive work environment where all employees feel valued and supported.

Our Mandate

Create Interoperability Between Financial Institutions

Implement a Domestic Payment Scheme

Provide National Payment Gateway

Serve as Central Interconnectivity for Clearing and Settlement
...
Ethswitch is mandated to provide interoperable, affordable, secured, and efficient e-Payment Infrastructure, clearing, dispute resolution and risk management services, to payment service providers in Ethiopia. Its overall goal is playing notable role in modernizing national payment system and enhancing financial inclusion.

Simplification and affordability of payments means payments are:

### Efficiently and Secured

conducted in the country efficiently in secured and safe manner anywhere anytime by everyone

### Interoperable

Interoperable, use shared infrastructure

### Standardized

Standardized solutions as per the criteria set

It also means disputes are resolved in shortest period possible while clearing and settlement of payment transactions are handled efficiently.
...
Director, Business Analysis and Digital Transformation

-

### Hunachew Chakle

Director, Card Personalization and Shared Services
