---
url: "https://www.ethiotelecom.et/fixed-bb-enterprise/"
title: "Ethio telecom — Fixed Broadband"
titleAm: "ኢትዮ ቴሌኮም: Fixed Broadband ኢንተርኔት አገልግሎት"
...
contentHash: "b744fb613659580d7a91fb53c46a2c238cd3474d"
generated_by: "ops/packs/fetch-pack.js --pack telecom"
packFormat: "2"
---

# Ethio telecom — Fixed Broadband · ኢትዮ ቴሌኮም: Fixed Broadband ኢንተርኔት አገልግሎት

Ethio telecom — coverage — Fixed Broadband. On this page: Fixed Broadband Internet​, Tips, Monthly Service Fee for Small Office/Home Office (SoHo) customers, Dedicated Internet Access (DIA) Service, Fixed wireless broadband internet, Telecom Service Via Satellite (VSAT), What is telecom Service Via Satellite (VSAT), Benefits of VSAT.

በአማርኛ፦ ሽፋንና ኢንተርኔት — Fixed Broadband። ይህ ገጽ ከኢትዮ ቴሌኮም ኦፊሴላዊ ድረ-ገጽ በእንግሊዝኛ የተወሰደ ነው። የጥቅል ዋጋ፣ የአገልግሎት ታሪፍ፣ የሽፋን አድማስና አጭር ቁጥሮች ያለማስታወቂያ ይለወጣሉ፤ ሕጎችና መመሪያዎችም ሊሻሻሉ ይችላሉ። ይህ ገጽ ወይም ሰነድ ከላይ በተጠቀሰው ቀን ኦፕሬተሩ ወይም የኢትዮጵያ ኮሙኒኬሽን ባለሥልጣን ባሳተመው መልኩ ነው። በማንኛውም ቁጥር ወይም ደንብ ላይ ከመወሰንዎ በፊት ኦፕሬተሩን (በመተግበሪያው፣ በዩኤስኤስዲ ወይም በሱቅ) ወይም ባለሥልጣኑን ያረጋግጡ።

ይህ ገጽ ስለ ኢትዮ ቴሌኮም Fixed Broadband ኢንተርኔት አገልግሎት ያብራራል። አገልግሎቱ በኮፐር ወይም በፋይበር የሚሰጥ ሲሆን፣ የፍጥነት አማራጮች ከ 7 Mbps ጀምሮ ይገኛሉ። ለንግድ ድርጅቶች ወርሃዊ ክፍያ ከ 2600 ብር ሲሆን፣ ለSOHO ደንበኞች ደግሞ ከ 1,100.00 ብር ይጀምራል።

Source: https://www.ethiotelecom.et/fixed-bb-enterprise/ (official Ethio telecom page, in English), fetched 2026-09-21. Everything below is that page as the institution wrote it — every price, validity, allowance, code and condition is copied, not restated. Where a table on the original page is a picture, the picture is not reproduced and no figure is supplied for it. Package prices, validity periods, tariffs, coverage and short codes change, often without notice, and laws and directives can be amended. This is the page or document exactly as the operator or the Ethiopian Communications Authority published it on the date above. Confirm with the operator (its app, USSD menu or shop) or with the Authority before you act on any figure or rule. BinaSmart is not a telecom operator or a regulator: this page is information, not advice, and nothing here activates a package, registers a SIM card, moves money or files a complaint.

## Fixed Broadband Internet​

Subscribe Fixed Wired Broadband Internet Service for your business​

Fixed wired broadband internet is a high speed internet service provided through copper or fiber with different access speed options starting from 7 Mbps. The payment is on fixed monthly basis irrespective of the volume of usage.

Enjoy Unlimited tele business Fiber Fixed Broadband Internet for your Business!

Access Speed (Mbps) | Monthly Rent |
7 | 2600 |
10 | 4300 |
20 | 6950 |
30 | 10400 |
...
Click here to read business rules
...
For more than 1 Gbps: Use below formula!
Y=1Gbps price of DIA service+708*(N-1024)

## Fixed wireless broadband internet

Fixed wireless broadband internet is a service with wireless access but fixed in a certain location. We have been providing Fixed Wireless Broadband internet service in different options, i.e., Point to Point (P2P) and Point to Multi-point (P2MP) internet, and VSAT.
Fixed wireless broadband signals are broadcast from a wireless base station to a receiver. The receiver is usually a fixed aerial, antenna, or dish device that you mount on your building, similar to a satellite dish. There needs to be a clear line of sight between the base station and the receiver for the service to work.
...
## What is telecom Service Via Satellite (VSAT)
