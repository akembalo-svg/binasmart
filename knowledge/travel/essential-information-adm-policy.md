---
url: "https://www.ethiopianairlines.com/et/information/essential-information/adm-policy"
title: "Ethiopian Airlines — Agency Debit Memos Policy"
...
contentHash: "b6255e9b0efcee4924d96c96c3730f6c302b7176"
generated_by: "ops/travel/fetch-airline.js"
packFormat: "2"
---

# Ethiopian Airlines — Agency Debit Memos Policy

Ethiopian Airlines — essential — Agency Debit Memos Policy. On this page: Agency Debit Memos &ndash; Ethiopian Airlines Policy, Related.

በአማርኛ፦ ከመብረርዎ በፊት — Agency Debit Memos Policy። ይህ ገጽ ከኢትዮጵያ አየር መንገድ ኦፊሴላዊ ድረ-ገጽ የተወሰደ ነው፤ አየር መንገዱ የአማርኛ ገጽ ስለማያዘጋጅ ጽሑፉ በእንግሊዝኛ ነው። ከመጓዝዎ በፊት በገጹ ላይ ያረጋግጡ።

Source: https://www.ethiopianairlines.com/et/information/essential-information/adm-policy (official Ethiopian Airlines page, in English), fetched 2026-09-16. Everything below is that page as it was written — figures, fees, kilos and time limits are copied, not restated. Confirm on the page before travelling.
...
# Agency Debit Memos &ndash; Ethiopian Airlines Policy
...
1.2. It is Ethiopian Airlines policy to mandate the use of electronic tickets- &ldquo;e-tickets&rdquo;.
...
2.7. It is Ethiopian Airlines policy to mandate the use of electronic tickets &ldquo;e-tickets&rdquo; on routes where e-tickets are available. Where a paper ticket is issued for an e-ticketable journey, Ethiopian Airlines may impose a charge that will be collected by ADM.
...
2.11. Ethiopian Airlines will endeavor to handle a rejected or disputed ADM in a timely manner. Where an Agent has disputed an ADM within the dispute period, provided the dispute was sent to the address notified on the ADM in question, Ethiopian Airlines will acknowledge receipt of the Agent&rsquo;s dispute, either via a status change in BSPlink or through a separate communication and stop the submission of the ADM onto the Agent&rsquo;s billing analysis. If Ethiopian Airlines reject the dispute an explanation for the rejection will be sent to the Agent.
