---
url: "https://www.ethiopianairlines.com/et/services/help-and-contact/frequently-asked-questions/other-faqs"
title: "Ethiopian Airlines — Other FAQs | Ethiopian Airlines Ethiopia | ET"
...
contentHash: "edab730d7acd232ce92cb37e40c62e1c166da4af"
generated_by: "ops/travel/fetch-airline.js"
packFormat: "2"
---

# Ethiopian Airlines — Other FAQs | Ethiopian Airlines Ethiopia | ET

Ethiopian Airlines — help — Other FAQs | Ethiopian Airlines Ethiopia | ET. On this page: Other FAQs.

በአማርኛ፦ እገዛና አድራሻ — Other FAQs | Ethiopian Airlines Ethiopia | ET። ይህ ገጽ ከኢትዮጵያ አየር መንገድ ኦፊሴላዊ ድረ-ገጽ የተወሰደ ነው፤ አየር መንገዱ የአማርኛ ገጽ ስለማያዘጋጅ ጽሑፉ በእንግሊዝኛ ነው። ከመጓዝዎ በፊት በገጹ ላይ ያረጋግጡ።

Source: https://www.ethiopianairlines.com/et/services/help-and-contact/frequently-asked-questions/other-faqs (official Ethiopian Airlines page, in English), fetched 2026-09-16. Everything below is that page as it was written — figures, fees, kilos and time limits are copied, not restated. Confirm on the page before travelling.
...
Yes, you can use online check-in for a group passenger. The maximum number of passengers to check-in at a time is ten passengers.

How do I book for a group passengers online?

Group booking is not available online. Please contact our local office or our global contact center.
Online group booking is possible only on the Ethiopian Airlines agency portal. For enrollment, please contact our local office

How is the group price calculated?

The price for a group is calculated independently of the lowest online price. It is calculated individually according to capacity and can be higher than the single seat fare sold online.
The number of seats available in the aircraft decreases per booking. It may therefore be the case that a seat is still available for an individual passenger at a lower price, but not to a group because of the number of travellers.

What is the maximum number of passengers for group booking?

Our booking system allow a single booking to contain a maximum number in party of 99 passengers. A maximum of 50 pre-reserved seat can be requested in one booking.
To assign seat to all 99 passengers in a booking, the booking must be divided in to at least two passengers name record (i. e. one with 50 seat and the other with 49)

Can I cancel my ticket if I have been booked within a group trip?

Yes, providing the required group size of at least 10 people remains and the group terms and conditions permit it.
If due to cancellations, the number of individuals in a group reduced to nine(9), it will no longer be considered as group and the booking will be handled as other individual bookings
Groups for which names are not obtained 30 days prior to flight departure date should be cancelled.

What is a group?

A group consists of at least 10 passengers (> 2 years old) traveling together over one or more flight segment.
Group Passengers must travel together on all outbound flights.

Do I need the name of all passenger’s name at the time of booking?

All group booking should have a group name while the PNR is created. The group name shall be assigned by the booking office. This will be unique name to establish the identity of the passengers traveling together,
The name of all the passengers may not be obtainable at the time of booking and such passengers shall be booked under a group name as may be established by the sponsor.
Group members name must be provided 60 days before the flight departure date. If that is not possible, the deadline for obtaining group name is 30 days.

How can I book a group trip?

Bookings for a group is not available online and it has to be done at our local office, call centre or via a travel agency.
Travel agencies are kindly requested to contact Ethiopian airlines group and operations team before any promise of space confirmation is given to the group.
All group request must be processed, evaluated and approved by a group controlling desk.

How far in advance can I book a group trip?

331 days &ndash; for a trip only using Ethiopian flights

Meal Selection

I have made a meal selection. If I changed my mind on board, will I still be able to choose from the flight’s menu?

Yes, you may still choose from the flight&rsquo;s menu. However, it will be
subject to availability on board.

Where do I go for meal selection?

Meal Selection can be done through Manage my trips on the Ethiopian Airlines website or on the Ethiopian Airlines mobile app.
Go to manage My trips
Select Passenger information and Meal selection
Select Add meal and special Request

When can I pre-select my meals?

You may select Special Meals 24 hours before your flight&rsquo;s departure.

If I did not pre-select my meals, will I still be served a meal when I’m on board?

Yes, you will still be able to choose your meals on board.

Why I am not able to select meal?

This could be due to one of the below reasons;-

- If the flight departure is less than 24 hours
- If the flight is operated by another airline
- If your booking is on waiting list
- If you flight is very short less than 2 hours

Can I pre-select my meals on codeshare flights?

You can only
pre-select your meals on codeshare flights that Ethiopian Airlines operates.

Can I change my mind about my meal choice?

Yes, you can change your meal selection up to 24 hours before departure.

I am currently waitlisted on my flight booking. Will I be able to pre-select my meals?

No, unfortunately meal selection is only available for confirmed flight
bookings. Waitlisted and reserved bookings are not applicable.

Is a fee payable for pre-selecting my meals?

There will be no payable fee if you select your meals through Manage
Booking on the Ethiopian Airlines website or on the Ethiopian Airlines mobile
app.
...
The terms and conditions are the full program details. They can be found on the &ldquo;Review & Submit&rdquo; page or on under the program section on our website. The terms & conditions must be agreed to before submitting your bid.
...
If you do not agree to the terms & conditions you won&rsquo;t be able to participate in the program.
...
Who can not claim for compensation?
...
Who is eligible for delayed/cancelled flight compensation program?
