---
url: "https://www.ethiopianairlines.com/et/information/special-needs/services-for-customers-with-special-need"
title: "Ethiopian Airlines — Special Assistance for USA Travel"
...
contentHash: "16273d1e50c9c247e48354cd4b66d6cc4e122836"
generated_by: "ops/travel/fetch-airline.js"
---

# Ethiopian Airlines — Special Assistance for USA Travel

Source: https://www.ethiopianairlines.com/et/information/special-needs/services-for-customers-with-special-need (official Ethiopian Airlines page, in English), fetched 2026-09-16. Everything below is that page as it was written — figures, fees, kilos and time limits are copied, not restated. Confirm on the page before travelling.

በአማርኛ፦ ይህ ገጽ ከኢትዮጵያ አየር መንገድ ኦፊሴላዊ ድረ-ገጽ (https://www.ethiopianairlines.com/et/information/special-needs/services-for-customers-with-special-need) የተወሰደ ነው። ክፍል፦ ልዩ እርዳታ። አየር መንገዱ የአማርኛ ገጽ ስለማያዘጋጅ ጽሑፉ በእንግሊዝኛ ነው። ኪሎዎች፣ ክፍያዎችና የጊዜ ገደቦች እንደተጻፉ ናቸው፤ ከመጓዝዎ በፊት በገጹ ላይ ያረጋግጡ።
...
Ethiopian Airlines is committed to providing safe, convenient, and comfortable service. This guide helps you plan your trip if you&rsquo;re a passenger with a disability.
Note
...
You&rsquo;re not required to disclose your disability. But the more detail we have, the better we can prepare.
If you can&rsquo;t use our website due to a disability, call us. We&rsquo;ll offer you web-based fares over the phone with no service fee as an accommodation.
...
● During booking: select your needs in the &lsquo;passenger information&rsquo; section.
...
If you&rsquo;ll use a battery-powered respiratory device in-flight, notify us at least 48 hours before departure. We&rsquo;ll confirm flight duration and help calculate how many batteries are needed.
...
○ Use an aisle chair and can&rsquo;t transfer over a fixed armrest
...
Note: Aircraft changes may affect seat assignments. We&rsquo;ll do our best to accommodate you.

Airport Assistance

Our staff can help with boarding, deplaning, and flight connections.
Connecting flights:
If you&rsquo;re non-ambulatory and have a long layover, we recommend traveling with a companion.
Pre-boarding:
...
Spillable (wet-cell):
● We&rsquo;ll disconnect and protect the terminals
...
● Battery may be removed if upright storage isn&rsquo;t possible

We do not transport damaged or leaking batteries.

Priority Cabin Stowage for Assistive Devices

A dedicated cabin closet is available to store one folding manual wheelchair (max: 13&rdquo; x 36&rdquo; x 42&rdquo;), without removing wheels.
...
Yes. We accept service animals (dogs only for emotional support). You&rsquo;ll need:
● A doctor&rsquo;s note for emotional support animals
...
Not usually. You&rsquo;ll need one if:
...
We provide oxygen for the flight only&mdash;you&rsquo;ll need to arrange ground oxygen yourself.
...
We don&rsquo;t provide personal attendants.
