---
url: "https://www.ethiopianairlines.com/et/services/help-and-contact/frequently-asked-questions/payment-faqs"
title: "Ethiopian Airlines — Payment FAQ | Ethiopian Airlines Ethiopia | ET"
...
contentHash: "35c19cd53b787bb019e1db938292fd958b81efb6"
generated_by: "ops/travel/fetch-airline.js"
---

# Ethiopian Airlines — Payment FAQ | Ethiopian Airlines Ethiopia | ET

Source: https://www.ethiopianairlines.com/et/services/help-and-contact/frequently-asked-questions/payment-faqs (official Ethiopian Airlines page, in English), fetched 2026-09-16. Everything below is that page as it was written — figures, fees, kilos and time limits are copied, not restated. Confirm on the page before travelling.

በአማርኛ፦ ይህ ገጽ ከኢትዮጵያ አየር መንገድ ኦፊሴላዊ ድረ-ገጽ (https://www.ethiopianairlines.com/et/services/help-and-contact/frequently-asked-questions/payment-faqs) የተወሰደ ነው። ክፍል፦ እገዛና አድራሻ። አየር መንገዱ የአማርኛ ገጽ ስለማያዘጋጅ ጽሑፉ በእንግሊዝኛ ነው። ኪሎዎች፣ ክፍያዎችና የጊዜ ገደቦች እንደተጻፉ ናቸው፤ ከመጓዝዎ በፊት በገጹ ላይ ያረጋግጡ።

#
Payment FAQs

Online Payement Related
...
Payment system on website doesn't work. Click "Purchase" but nothing happens. Have tried different payment options and different browsers. Same issue with the app.
...
I booked the flight ticket twice because it said that it didn’t worked the first but it took the money twice from the bank account
...
I pay for ticket via bank transfer, and I was debited, but I have not received my tickets confirmation .
...
I can't finalize payment. Could you please help? The screen looks white and it freezing.
...
I can't pay because the PayPal option is no longer available.
...
I've paid for a booked ticket. The money was deducted from my banking account, but I did not receive my booking.
...
I bought 4 tickets but only one ticket has been paid and the rest of money was send back to bank account. I do not know the reason.

Our support desk will contact you if there is uncollected amount.

Can I make payment by using my local debit card?
...
Why is the website stuck at the payment page?
...
Can I make payment online with my credit card for another person when I am not travelling myself?
...
When will you charge my credit card after I have made a booking online?
