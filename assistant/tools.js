...
const DEFS = [
  ...
  { name: 'remember', description: 'Save something about this user for next time: their name, phone, preferred language, home or work place (after search_places gave coordinates), or a short note. Call it when the user tells you such a thing or asks you to remember.',
