...
(function () {
  ...
  var css = '.bina-ft{background:#0b2a26;color:#cfe7e1;font-family:"Noto Sans Ethiopic","Plus Jakarta Sans",system-ui,sans-serif;padding:26px 14px 20px;margin-top:40px;line-height:1.5;font-size:13px}'
    ...
    + '.bina-ft h3{color:#fff;font-size:11px;font-weight:900;letter-spacing:.03em;margin:0 0 6px;text-transform:uppercase;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
    + '.bina-ft h3 i{font-style:normal;color:#5c8f85;display:none}'
    ...
    + '@media(min-width:560px){.bina-ft{padding:34px 18px 26px;font-size:14px}.bina-ft .cols{gap:22px}.bina-ft h3{font-size:13px}.bina-ft h3 i{display:inline}'
  ...
  var html = '<div class="in"><div class="brand">🇪🇹 Bina<span>Smart</span></div><div class="cols">'
    + COLS.map(function (c) {
      return '<div><h3>' + c[0] + ' <i>· ' + c[1] + '</i></h3>' + c[2].map(function (l) {
