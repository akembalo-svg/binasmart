...
sites = [
    ...
    },
    {
        ...
        'workaround': 'None needed for the pages held; the freshness job should re-probe whether the host answers from this server.',
        'allow': ['^(' + alt(saf_paths) + ')$'],
    ...
    },
    {
        ...
        'reach': 'up but unreached from this server',
        'checked': '2026-09-22',
