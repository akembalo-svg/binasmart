...
(async () => {
  if (process.argv.includes('--clean')) {
    ...
    await prisma.film.upsert({ where: { slug: SLUGS[0] }, update: {}, create: { slug: SLUGS[0], title: 'Big Buck Bunny (demo)', titleAm: 'ቢግ ባክ ባኒ (ማሳያ)', year: 2008, runtimeMin: 10, rating: 'G', language: 'No dialogue', genre: 'Animation',
      ...
      posterUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Big_buck_bunny_poster_big.jpg/480px-Big_buck_bunny_poster_big.jpg', sourceKind: 'mp4', sourceUrl: 'https://download.blender.org/peach/bigbuckbunny_movies/BigBuckBunny_320x180.mp4',
